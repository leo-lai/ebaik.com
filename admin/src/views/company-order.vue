  ...
  <el-container class="l-h100">
    <el-header class="l-padding-0 l-bg-white" height="auto">
      <div class="l-filter-top">
        <ul class="l-tab-tit">
          <li class="_active2" @click="$router.push('/company/order')">订单</li>
    ...
    <el-main>
      <el-table border stripe element-loading-spinner="el-icon-loading" element-loading-text="拼命加载中" :data="list.data" v-loading="list.loading">
        <el-table-column align="center" prop="" label="业务员" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="生成日期" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="订单日期" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="交货日期" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="来源" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="客户名称" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="合同编号" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="订单性质" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="销售类型" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="返单性质" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="订单内容" width="200"></el-table-column>
        <el-table-column align="center" prop="" label="合同总金额" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="付款方式" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="服务费" width="120"></el-table-column>
        <el-table-column align="center" prop="" label="其他重要条款" width="200"></el-table-column>
        <el-table-column align="center" prop="" label="订单备注" width="120"></el-table-column>
